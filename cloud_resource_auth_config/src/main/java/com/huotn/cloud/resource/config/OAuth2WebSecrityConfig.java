...
import com.huotn.cloud.resource.properties.ResourceServerConfigProperties;
...
public class OAuth2WebSecrityConfig extends WebSecurityConfigurerAdapter {
    ...
    public ResourceServerTokenServices tokenServices(){
        ...
        tokenServices.setClientId(resourceServerConfigProperties.getClientId());
        tokenServices.setClientSecret(resourceServerConfigProperties.getClientSecret());
        tokenServices.setCheckTokenEndpointUrl(resourceServerConfigProperties.getCheckTokenEndpointUrl());
        //读取相关的用户信息。
